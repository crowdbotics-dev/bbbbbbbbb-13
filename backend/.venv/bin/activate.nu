...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/app/tmp/projects/mobile_app_react_native/bbbbbbbbb_13/backend/.venv'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/app/tmp/projects/mobile_app_react_native/bbbbbbbbb_13/backend/.venv/bin/deactivate.nu'
